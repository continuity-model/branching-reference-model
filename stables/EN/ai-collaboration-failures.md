...
- 🇺🇸 English (current)
- 🇯🇵 [日本語](../JP/ai-collaboration-failures_JP.md)
...
They originate from **structural properties of AI text generation.**

Below are representative examples observed in real AI collaboration.
...
Stable Modes are not just individual tools.  
They are part of a **structured reasoning model for AI collaboration.**

The reasoning domains and their corresponding modes are described in the Stable Thinking Stack.
