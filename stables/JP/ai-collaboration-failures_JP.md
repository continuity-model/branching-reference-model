...
- 🇯🇵 日本語（current）
- 🇺🇸 [English](../EN/ai-collaboration-failures.md)
...
**長い会話の中で、初期プロンプトの影響が徐々に弱まり、最終的に会話整合性（coherence）が支配的になる様子**
...
Stable Modes は単なる個別ツールではなく、  
AI協働を **推論領域ごとに整理する構造モデル**として設計されています。
