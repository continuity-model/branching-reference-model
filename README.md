...
→ **[Download Symptom Stable v1.2](https://github.com/continuity-model/branching-reference-model/releases/download/symptom-stable-v1.2/Symptom_Stable_v1_2_EN_Finalized.zip)**
